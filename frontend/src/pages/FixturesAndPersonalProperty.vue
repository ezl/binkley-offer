<template>
  <div>
    ...
    <b-row align-v="baseline">
      <b-col md="2"/>
      <b-col cols="6" sm="3" md="2" class="px-md-2 px-sm-2">
        <div>
    ...
    <b-row align-v="baseline">
      ...
      <b-col cols="6" sm="3" md="2">
        <div>
          <CheckboxInput v-model="pdfBody.central_air_conditioner" text-label="Central Air Conditioner"></CheckboxInput>
      ...
      <b-col cols="6" sm="3" md="2">
        <div>
          ...
          <TextInput v-if="pdfBody.window_air_conditioner" v-model="pdfBody.window_air_conditioner_details"></TextInput>
        </div>
      </b-col>
      <b-col cols="6" sm="3" md="2">
        <div>
    ...
    <b-row align-v="baseline">
      ...
      <b-col cols="6" sm="3" md="2">
        <div>
          <CheckboxInput v-model="pdfBody.existing_storms_and_screens" text-label="Attached Gas Grill"></CheckboxInput>
