<template>
  <div v-if="isLoaded">
      ...
      <b-row>
        <b-col>
          ...
          <b-progress class="my-2">
            <b-progress-bar v-if="propertyType === 'attached'" :value="4" :max="8" :label="'4 of 8'" show-progress
                            animated></b-progress-bar>
            <b-progress-bar v-else-if="propertyType === 'detached'" :value="4" :max="7" :label="'4 of 7'" show-progress
                            animated></b-progress-bar>
          </b-progress>
        </b-col>
      </b-row>
      ...
      <b-row align-v="baseline">
        ...
        <b-col cols="6" sm="3" md="3">
          <div>
            ...
            <TextInput v-if="pdfBody.oven_or_range" :hidden="true"
                       v-model="pdfBody.oven_or_range_details"></TextInput>
          </div>
        </b-col>
        <b-col cols="6" sm="3" md="3">
          <div>
      ...
      <b-row align-v="baseline">
        <b-col cols="6" sm="3" md="3">
          <div>
            ...
            <TextInput v-if="pdfBody.garbage_disposal" :hidden="true"
                       v-model="pdfBody.garbage_disposal_details"></TextInput>
          </div>
        </b-col>
        <b-col cols="6" sm="3" md="3">
          <div>
            <CheckboxInput v-model="pdfBody.trash_compactor" text-label="Trash Compactor"></CheckboxInput>
            <TextInput v-if="pdfBody.trash_compactor" :hidden="true"
                       v-model="pdfBody.trash_compactor_details"></TextInput>
          </div>
        </b-col>
        <b-col cols="6" sm="3" md="3">
          <div>
    ...
    <b-card bg-variant="light" class="border-0 mb-3" title="Media">
      <b-row align-v="baseline">
        <b-col cols="6" sm="3" md="3">
          <div>
            <CheckboxInput v-model="pdfBody.intercom_system" text-label="Intercom System"></CheckboxInput>
            <TextInput v-if="pdfBody.intercom_system" :hidden="true"
                       v-model="pdfBody.intercom_system_details"></TextInput>
          </div>
        </b-col>
        <b-col cols="6" sm="3" md="3">
          <div>
            <CheckboxInput v-model="pdfBody.security_system" text-label="Security System"></CheckboxInput>
            <TextInput v-if="pdfBody.security_system" :hidden="true"
                       v-model="pdfBody.security_system_details"></TextInput>
            <b-row align-v="baseline">
        ...
        <b-col cols="6" sm="3" md="3">
          <div>
            ...
            <TextInput v-if="pdfBody.satellite_dish" :hidden="true"
                       v-model="pdfBody.satellite_dish_details"></TextInput>
          </div>
        </b-col>
        <b-col cols="6" sm="3" md="3">
          <div>
      ...
      <b-row align-v="baseline">
        ...
        <b-col cols="6" sm="3" md="3">
          <div>
            ...
            <TextInput v-if="pdfBody.multimedia_equipment" :hidden="true"
                       v-model="pdfBody.multimedia_equipment_details"></TextInput>
          </div>
        </b-col>
      </b-row>
    </b-card>
    <b-card bg-variant="light" class="border-0 mb-3" title="Interior">
      <b-row align-v="baseline">
        <b-col cols="6" sm="3" md="3">
          <div>
      ...
      <b-row align-v="baseline">
        <b-col cols="6" sm="3" md="3">
          <div>
            ...
            <TextInput v-if="pdfBody.water_softener" :hidden="true"
                       v-model="pdfBody.water_softner_details"></TextInput>
          </div>
        </b-col>
        <b-col cols="6" sm="3" md="3">
          <div>
        ...
        <b-col cols="6" sm="3" md="3">
          <div>
            <CheckboxInput v-model="pdfBody.window_air_conditioner"
                           text-label="Window Air Conditioner"></CheckboxInput>
        ...
        <b-col cols="6" sm="3" md="3">
          <div>
            ...
            <TextInput v-if="pdfBody.electronic_air_filter" :hidden="true"
                       v-model="pdfBody.electronic_air_filter_details"></TextInput>
          </div>
        </b-col>
      </b-row>
      <b-row align-v="baseline">
        <b-col cols="6" sm="3" md="3">
          <div>
            ...
            <TextInput v-if="pdfBody.central_humidifier" :hidden="true"
                       v-model="pdfBody.central_humidifier_details"></TextInput>
          </div>
        </b-col>
        <b-col cols="6" sm="3" md="3">
          <div>
            <CheckboxInput v-model="pdfBody.lighting_fixtures" text-label="Lighting Fixtures"></CheckboxInput>
            <TextInput v-if="pdfBody.lighting_fixtures" :hidden="true"
                       v-model="pdfBody.lighting_fixtures_details"></TextInput>
          </div>
        </b-col>
        <b-col cols="6" sm="3" md="3">
          <div>
        ...
        <b-col cols="6" sm="3" md="3">
          <div>
            ...
            <TextInput v-if="pdfBody.fireplace_gas_log" :hidden="true"
                       v-model="pdfBody.fireplace_gas_log_details"></TextInput>
          </div>
        </b-col>
      </b-row>
      <b-row align-v="baseline">
        ...
        <b-col cols="6" sm="3" md="3">
          <div>
            ...
            <TextInput v-if="pdfBody.window_treatments" :hidden="true"
                       v-model="pdfBody.window_treatments_details"></TextInput>
          </div>
        </b-col>
        <b-col cols="6" sm="3" md="3">
          <div>
    ...
    <b-card bg-variant="light" class="border-0" title="Exterior">
      <b-row align-v="baseline">
        <b-col cols="6" sm="3" md="3">
          <div>
            <CheckboxInput v-model="pdfBody.electronic_garage_door"
                           text-label="Electronic Garage Door"></CheckboxInput>
        ...
        <b-col cols="6" sm="3" md="3">
          <div>
            ...
            <TextInput v-if="pdfBody.attached_gas_grill" :hidden="true"
                       v-model="pdfBody.attached_gas_grill_details"></TextInput>
          </div>
        </b-col>
        <b-col cols="6" sm="3" md="3">
          <div>
      ...
      <b-row align-v="baseline">
        <b-col cols="6" sm="3" md="3">
          <div>
            ...
            <TextInput v-if="pdfBody.radiator_covers" :hidden="true"
                       v-model="pdfBody.radiator_covers_details"></TextInput>
          </div>
        </b-col>
        <b-col cols="6" sm="3" md="3">
          <div>
            <CheckboxInput v-model="pdfBody.all_planted_vegetation"
                           text-label="All Planted Vegetation"></CheckboxInput>
          </div>
        </b-col>
        <b-col cols="6" sm="3" md="3">
          <div>
