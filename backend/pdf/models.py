...
class PdfFields(models.Model):
    ...
    refrigerator_details = models.TextField(null=True, default="")
    oven_or_range = models.BooleanField(default=False)
    oven_or_range_details = models.TextField(null=True, default="")
    microware = models.BooleanField(default=False)
    microwave_details = models.TextField(null=True, default="")
    dishwasher = models.BooleanField(default=False)
    dishwasher_details = models.TextField(null=True, default="")
    garbage_disposal = models.BooleanField(default=False)
    garbage_disposal_details = models.TextField(null=True, default="")
    trash_compactor = models.BooleanField(default=False)
    trash_compactor_details = models.TextField(null=True, default="")
    washer = models.BooleanField(default=False)
    washer_details = models.TextField(null=True, default="")
    dryer = models.BooleanField(default=False)
    dryer_details = models.TextField(null=True, default="")
    water_softener = models.BooleanField(default=False)
    water_softner_details = models.TextField(null=True, default="")
    sump_pump = models.BooleanField(default=False)
    sump_pump_details = models.TextField(null=True, default="")
    smoke_and_monoxide_detectors = models.BooleanField(default=False)
    smoke_and_carbon_monoxide_detectors_details = models.TextField(null=True, default="")
    intercom_system = models.BooleanField(default=False)
    intercom_system_details = models.TextField(null=True, default="")
    security_system = models.BooleanField(default=False)
    security_system_details = models.TextField(null=True, default="")
    ...
    satellite_dish_details = models.TextField(null=True, default="")
    attached_tv = models.BooleanField(default=False)
    attached_tv_details = models.TextField(null=True, default="")
    tv_antenna = models.BooleanField(default=False)
    tv_antenna_details = models.TextField(null=True, default="")
    multimedia_equipment = models.BooleanField(default=False)
    multimedia_equipment_details = models.TextField(null=True, default="")
    central_air_conditioner = models.BooleanField(default=False)
    central_air_conditioner_details = models.TextField(null=True, default="")
    window_air_conditioner = models.BooleanField(default=False)
    window_air_conditioner_details = models.TextField(null=True, default="")
    electronic_air_filter = models.BooleanField(default=False)
    electronic_air_filter_details = models.TextField(null=True, default="")
    central_humidifier = models.BooleanField(default=False)
    central_humidifier_details = models.TextField(null=True, default="")
    lighting_fixtures = models.BooleanField(default=False)
    lighting_fixtures_details = models.TextField(null=True, default="")
    electronic_garage_door = models.BooleanField(default=False)
    electronic_garage_door_with_remote_unit_details = models.TextField(null=True,
                                                                       default="")
    tacked_down_carpeting = models.BooleanField(default=False)
    fireplace_screen_and_equipment = models.BooleanField(default=False)
    fireplace_screen_and_equipment_details = models.TextField(null=True, default="")
    fireplace_gas_log = models.BooleanField(default=False)
    fireplace_gas_log_details = models.TextField(null=True, default="")
    firewood = models.BooleanField(default=False)
    firewood_details = models.TextField(null=True, default="")
    attached_gas_grill = models.BooleanField(default=False)
    attached_gas_grill_details = models.TextField(null=True, default="")
    existing_storms_and_screens = models.BooleanField(default=False)
    existing_storms_and_screens_details = models.TextField(null=True, default="")
    window_treatments = models.BooleanField(default=False)
    window_treatments_details = models.TextField(null=True, default="")
    other_equipment = models.BooleanField(default=False)
    other_equipment_details = models.TextField(null=True, default="")
    built_in_or_attached_shelves_or_cabinets = models.BooleanField(default=False)
    built_int_or_attached_shelves_or_cabinets_details = models.TextField(null=True,
                                                                         default="")
    ceiling_fan = models.BooleanField(default=False)
    ceiling_fan_details = models.TextField(null=True, default="")
    radiator_covers = models.BooleanField(default=False)
    radiator_covers_details = models.TextField(null=True, default="")
    ...
    purchase_price = models.TextField(null=True, default="")
    credit_buyer_at_closing_yes = models.BooleanField(default=False)
    credit_buyer_at_closing_if_yes_amount = models.TextField(null=True, default="")
    credit_buyer_at_closing_no = models.BooleanField(default=False)
    credit_buyer_at_closing_if_no_percentage = models.TextField(null=True, default="")
    home_warranty_amount = models.TextField(null=True, default="")
    brokerage_for_earnest_money = models.TextField(null=True, default="")
    initial_earnest_money_amount = models.TextField(null=True, default="")
    how_buyer_deposits_earnest_money = models.TextField(null=True, default="")
    initial_earnest_money_due_date = models.TextField(null=True, default="")
    balance_of_earnest_money_amount = models.TextField(null=True, default="")
    balance_of_earnest_money_due_date = models.TextField(null=True, default="")
    ...
    mortgage_contingency_date = models.TextField(null=True, default="")
    buyer_loan_to_value = models.TextField(null=True, default="")
    buyer_interest_rate = models.TextField(null=True, default="")
    buyer_loan_term = models.TextField(null=True, default="")
    closing_date = models.TextField(null=True, default="")
    ...
    dual_agent_broker_name = models.TextField(null=True, default="")
    length_of_attorney_review = models.TextField(null=True, default="")
    length_of_inspection_period = models.TextField(null=True, default="")
    offer_date = models.TextField(null=True, default="")
    designated_agent = models.TextField(null=True, default="")
    agent_mls = models.TextField(null=True, default="")
    agent_license = models.TextField(null=True, default="")
    brokerage = models.TextField(null=True, default="")
    brokerage_mls = models.TextField(null=True, default="")
    brokerage_license = models.TextField(null=True, default="")
    broker_address = models.TextField(null=True, default="")
    agent_phone = models.TextField(null=True, default="")
    agent_fax = models.TextField(null=True, default="")
    broker_email = models.TextField(null=True, default="")
    attorney_name = models.TextField(null=True, default="")
    attorney_address = models.TextField(null=True, default="")
    attorney_phone = models.TextField(null=True, default="")
    attorney_fax = models.TextField(null=True, default="")
    attorney_email = models.TextField(null=True, default="")
    lender_name = models.TextField(null=True, default="")
    lender_company = models.TextField(null=True, default="")
    lender_address = models.TextField(null=True, default="")
    lender_phone = models.TextField(null=True, default="")
    lender_fax = models.TextField(null=True, default="")
    lender_email = models.TextField(null=True, default="")
    offer_deadline = models.TextField(null=True, default="")
    homeowner_yes = models.BooleanField(default=False)
    homeowner_no = models.BooleanField(default=False)
    buyer_name = models.TextField(null=True, default="")
    buyer_email = models.TextField(null=True, default="")
    seller_name = models.TextField(null=True, default="")
    seller_email = models.TextField(null=True, default="")
    special_assessment_yes = models.BooleanField(default=False)
    special_assessment_no = models.BooleanField(default=False)
    deliver_association = models.TextField(null=True, default="")
    homeowner = models.BooleanField(default=False)
    senior = models.BooleanField(default=False)
    senior_freeze = models.BooleanField(default=False)
    historical = models.BooleanField(default=False)
    prorated = models.TextField(null=True, default="")
    parking_space_numbers = models.TextField(null=True, default="")
    ...
    parking_pin = models.TextField(null=True, default="")
    seller_also_transfers = models.TextField(null=True, default="")
    items_excluded = models.TextField(null=True, default="")
    contract_accepted_on_or_before = models.TextField(null=True, default="")
    attached_riders_and_addendums = models.TextField(null=True, default="")
    riders_or_addendums = models.TextField(null=True, default="")
    ...
    storage_pin = models.TextField(null=True, default="")
...
#     riders_or_addendums = models.TextField(null=True, default=None)
#     offer_deadline = models.TextField(null=True, default=None)
#     homeowner_yes = models.BooleanField(default=False)
#     homeowner_no = models.BooleanField(default=False)
#     buyer_name = models.TextField(null=True, default=None)
#     buyer_email = models.TextField(null=True, default=None)
#     seller_name = models.TextField(null=True, default=None)
#     seller_email = models.TextField(null=True, default=None)
#     special_assessment_yes = models.BooleanField(default=False)
#     special_assessment_no = models.BooleanField(default=False)
#     deliver_association = models.TextField(null=True, default=None)
#     homeowner = models.BooleanField(default=False)
#     senior = models.BooleanField(default=False)
#     senior_freeze = models.BooleanField(default=False)
#     historical = models.BooleanField(default=False)
#     prorated = models.TextField(null=True, default=None)
#     parking_space_numbers = models.TextField(null=True, default=None)
#     deeded = models.BooleanField(default=False)
#     assigned = models.BooleanField(default=False)
#     indoor = models.BooleanField(default=False)
#     outdoor = models.BooleanField(default=False)
