...
class CreatePdfSerializer(serializers.Serializer):
    ...
    deliver_association = serializers.CharField(allow_null=True, default="")
    ...
    prorated = serializers.CharField(allow_null=True, default="")
    parking_space_numbers = serializers.CharField(allow_null=True, default="")
